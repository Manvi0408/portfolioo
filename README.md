...
1. **Clone the repository:**
    ...
    ```bash
    git clone https://github.com/Manvi0408/3d-portfolio.git
    cd 3d-portfolio
    ```
...
If you use this portfolio, a credit or link back to the [original repo](https://github.com/Manvi0408/3d-portfolio) would be much appreciated ❤️
